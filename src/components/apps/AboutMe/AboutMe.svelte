...
<section class="container">
	...
	<aside class:light={preferences.theme.scheme === 'light'}>
		<nav>
			<a href="mailto:chiragbaldia@gmail.com" use:external> <BlogIcon /> Email </a>
			<a href="https://github.com/chirag-says" use:external> <GithubIcon /> Github </a>

			<hr />

			<a href="https://instagram.com/heyim.chirag" use:external>
				<InstagramIcon />
				Instagram
			</a>
	...
	<section class="content">
		<img height="200" width="200" src="/profile/chirag.png" alt="Chirag Profile pic" />
		...
		<h2>
			I'm a Fullstack Software Engineer from Bengaluru
		...
		<p>
			I build scalable web applications, real-time systems, and AI-powered platforms. 
			I love working with Next.js, React, Node.js, and Supabase!
		...
		<p>
			Currently, I'm a Software Engineer Intern at IshiSoft, where I develop 
			production-grade platforms. I also enjoy dabbling in Go, Python, and Machine Learning.
		</p>
	</section>
</section>
